...
class AppColors {
  ...
  static const Color primaryLight = Color(0xFFE6C55B); // Lighter Gold
  static const Color primaryDark = Color(0xFFA58522); // Darker Gold
  static const Color primarySurface = Color(0xFFFDF8E8); // Very light gold surface
  static const Color primaryBorder = Color(0xFFEAD07C);
  ...
  // Fallbacks for older widgets during transition
